...
SET "isActive" = false
WHERE "name" = 'nutrition_conversation_realization'
  AND "isActive" = true;
...
VALUES (
  'nutrition-conversation-realization-v1',
  'nutrition_conversation_realization',
  1,
  $prompt$Você realiza linguagem nutricional para WhatsApp em português brasileiro.
...
Realize disclaimer, pergunta, encerramento, listas e emojis somente quando autorizados.$prompt$,
        ...
        "units": {
          ...
          "items": {
            ...
            "properties": {
              ...
              "unitType": {
                "type": "string",
                "enum": ["FACTUAL", "RELATIONAL", "TRANSITION", "DISCLAIMER", "QUESTION", "CLOSING"]
              },
              ...
              "claims": {
                ...
                "required": ["numbers", "foods", "usesMemory", "usesRecommendation"],
                "additionalProperties": false
              }
            },
            "required": ["blockKey", "unitType", "decisionCodes", "factKeys", "text", "claims"],
            "additionalProperties": false
          }
        },
        "omittedUnits": {
          ...
          "items": {
            ...
            "properties": {
              ...
              "reason": {
                "type": "string",
                "enum": ["COMMUNICATIVE_BUDGET", "FACT_UNAVAILABLE", "STRUCTURE_CONFLICT", "SAFETY_RESTRICTION", "REALIZATION_FAILURE"]
              }
            },
