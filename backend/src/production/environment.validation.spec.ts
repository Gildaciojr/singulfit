...
describe('production environment validation', () => {
  function validEnvironment(): Record<string, string> {
    return {
      NODE_ENV: 'production',
      RUNTIME_MODE: 'API',
      DATABASE_URL: 'postgresql://user:password@postgres:5432/nutrafit',
      JWT_ACCESS_SECRET: 'a'.repeat(48),
      JWT_REFRESH_SECRET: 'b'.repeat(48),
      JWT_ISSUER: 'nutrafit-api',
      JWT_AUDIENCE: 'nutrafit-app',
      CORS_ALLOWED_ORIGINS: 'https://app.nutrafit.example',
      ...
      EVOLUTION_BASE_URL: 'https://evolution.nutrafit.example',
      ...
      UPLOAD_PATH: '/var/lib/nutrafit/uploads',
